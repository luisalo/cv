...
``Neutralizing Free Choice Items via Maximal Domain Restriction: Farsi \textit{-i} Indefinites'' (with Esmail Moghiseh), \textit{Semantics and Linguistic Theory 29}, University of California at Los Angeles, May 18, 2019.
...
``Overcoming the Unexpected: the Tagalog Ability / Involuntary Action Verbal Inflection'' (with Henrison Hsieh), \textit{27h Annual West Coast Conference on Formal Linguistics}, University of Calgary, April 28, 2017 [presented by co-author.]

``Anchored implicatives: Tagalog Ability/Involuntary Action'' (with Henrison Hsieh), \textit{The 24th meeting of the Austronesian Formal Linguistics}, the University of Washington, April 9, 2017. [presented by co-author.]
...
Jonathan Palucci, ``On the Scope Effects of \textit{Any}.'' (in progress)
